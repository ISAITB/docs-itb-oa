...
Your account credentials are those provided to you by your administrator or by you in case you self-registered (see :ref:`login__create_account`).
...
If this is the first time you are logging into the Test Bed your password will likely be
