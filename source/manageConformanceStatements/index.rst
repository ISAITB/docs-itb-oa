...
.. note::
    **Default selection:** In case where you have a single domain, specification or actor to select it will be preselected by default (i.e. highlighted in blue). Moreover,
    if you are testing as an actor that is defined by your community administrator as the specification's default, this will be preselected even if additional actors exist.
