...
.. note::
    Editing a conformance statement's configuration parameters is a prerequisite that you, as organisation administrator,
    have to complete as your basic users lack the privileges to do so.
