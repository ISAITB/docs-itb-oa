...
This is a patch release to correct an issue reported by users relating to the validation of test suites.
...
.. csv-table::
  ...
  ITB-1970 | :ui:`UI` | Scriptlets defining btxn steps cause the test suite validation to fail
